 ...
 * @param alg the quaternion algebra
 */
void quat_lideal_shortest_equivalent(quat_left_ideal_t *equiv,
 ...
 *
 */
void quat_lideal_generator_small_coprime(quat_alg_elem_t *gen,
                                         const quat_left_ideal_t *lideal,
                                         const quat_alg_t *alg,
...
void quat_qlapoty_gen_to_dim2_lattice(ibz_mat_2x2_t *lat,
                                      ibz_vec_2_t *target,
                                      const quat_alg_elem_t *gen,
                                      const ibz_t *N);

void quat_qlapoty_get_short_basis(ibz_mat_2x2_t *basis,
                                  ibz_vec_2_t *target,
                                  const ibz_vec_2_t *st,
                                  const quat_alg_elem_t *alpha0,
                                  const ibz_t *N);

int quat_qlapoty_initialize_bounds(ibz_vec_2_t *ab,
                                   ibz_vec_2_t *omega,
                                   quat_alg_elem_t *gen,
...
int quat_qlapoty_loop_two(ibz_t *l,
                          ibz_t *s,
                          ibz_t *t,
                          ibz_t *sc,
                          ibz_t *tc,
...
void quat_qlapoty_loop_one(quat_alg_elem_t *alpha0,
