...
int dim2id2iso_ideal_to_isogeny_clapotis(quat_alg_elem_t *beta1,
                                         ...
                                         const quat_alg_t *Bpoo);
/**
 * @brief Tate pairing of a torsion basis
 *
 * @param out Output: Tate pairing of basis.P and basis.Q
 ...
 *
 * This is a wrapper around the tate function of the ec module. Used only within the module
 */
void tate_basis(fp2_t *out, int e, const ec_basis_t *basis, const ec_curve_t *curve);
